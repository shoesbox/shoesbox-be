...
public class SseController {
    ...
    public ResponseBodyEmitter subscribe(HttpServletResponse response) {
        ...
        sseEmitter.onCompletion(() -> sseEmitters.remove(currentMemberId));
        sseEmitter.onTimeout(() -> sseEmitters.remove(currentMemberId));
        sseEmitter.onError((e) -> sseEmitters.remove(currentMemberId));
        return sseEmitter;
    }
